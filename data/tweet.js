...
const SELECT_JOIN = 'SELECT tw.id, tw.text, tw.createdAt, wt.userId, us.username, us.name, us.email, us.url from tweets as tw JOIN users as us ONtw.userId = us.id';
